...
steps:
- ポテトフライを適切な大きさに切ります。肉の場合は、ニンニクと醤油を揉み込んで15分間置いておきます。塩とコショウ粉を揉み込んで下味をつけます。
- フライパンにごま油を熱し、ニンニクと玉ねぎを炒め、漬け込んだポテトフライを加えて炒め合わせます。
- 合わせたコチュジャンと出汁を流し入れ、中火で炒め絡めながら、ポテトフライにしっかりと火を通します。
