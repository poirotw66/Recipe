...
steps:
- バンズまたはデニッシュの内側にバターを塗り、フライパンで焼き色がつくまで焼く。牛肉排 180公克、起司 40公克、炸墨西哥辣椒 適量、薯塊 250公克を用意する。
- 中火でパティやカツを焼き、起火直前にチーズをのせてフタをして30秒蒸らして溶かす。
- 下のパンにソース（橄欖油 1大匙、海鹽 1/3小匙、黑胡椒碎 1/4小匙、BBQ 醬 2大匙、辣椒碎 1/2小匙）を塗り、レタス、トマト、ピクルス、パティ、目玉焼きを順にのせる。
