...
steps:
- バンズまたはデニッシュの内側にバターを塗り、フライパンで焼き色がつくまで焼く。歐包 2份、火腿 適量、起司 40公克、荷包蛋 2顆を用意する。
- 中火でパティやカツを焼き、起火直前にチーズをのせてフタをして30秒蒸らして溶かす。
- 下のパンにソース（橄欖油 1大匙、海鹽 1/3小匙、黑胡椒碎 1/4小匙、楓糖漿 2大匙、鮮奶油 適量）を塗り、レタス、トマト、ピクルス、パティ、目玉焼きを順にのせる。
...
- ピクルス追加
faqs:
- question: 厚烤奶油 Ham 三明治 を店っぽく仕上げるコツは？
