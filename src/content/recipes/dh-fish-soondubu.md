...
steps:
- "備料：洋蔥 0.5 顆切絲，青蔥 1 根切段；鯛魚片 150 克切約 3 公分塊，用廚房紙巾吸乾表面水分；蒜末 1 大匙、韓式辣椒醬 1.5 大匙、醬油 1 大匙、韓式芝麻油 1 大匙分裝小皿備用；雞蛋 1 顆磕入小碗。"
- 韓式辣湯鍋或厚底小鍋以中火加熱，倒入韓式芝麻油 1 大匙，下蒜末 1 大匙與洋蔥絲，炒至洋蔥透明、蒜香釋出（約 2 分鐘）。
- 加入韓式辣椒醬 1.5 大匙，轉小火以鍋鏟不停推拌約 1 分鐘，炒出紅油香氣（注意勿炒焦）。
- 放入鯛魚片 150 克，轉中火單面煎約 1 分鐘至表面變白，再輕推翻面，讓魚片表面定型（勿大力翻動以免碎裂）。
- 倒入高湯 400 毫升與醬油 1 大匙，大火煮滾後轉中小火，蓋鍋慢煮 5～8 分鐘至湯頭入味、魚片熟透。
