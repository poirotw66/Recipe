...
restaurantSource:
  ...
  dishName: 橙香法式丹麥 水波海鮮洋芋
  region: 全台連鎖
intro: 這道 橙香法式丹麥 水波海鮮洋芋 參考貳樓 Second Floor Cafe 常見做法，會先把 橙香丹麥、水波蛋、海鮮 分段處理，再依 早午餐 的出餐邏輯完成整盤。
steps:
...
- 巴薩米克另外放
faqs:
- question: 想把 橙香法式丹麥 水波海鮮洋芋 做得更像貳樓版本，最重要的是什麼？
...
橙香法式丹麥 水波海鮮洋芋 的在家還原版，重點是把 橙香丹麥、水波蛋、海鮮 做出分層口感，並保留貳樓常見的 早午餐 大份量出餐感。
