...
steps:
- 歐包 2份를 가로로 잘라 단면에 버터를 살짝 바르고, 180℃ 오븐에서 5~7분 굽혀 표면이 금색으로 바삭하게 만듭니다(또는 약불 팬에서 양면을 노릇하게 굽습니다).
- 培根 80g을 작게 썰어 기름 없이 팬에 중약불로 3~4분 볶아 기름이 나오고 가장자리가 바삭해지면 건집니다. 키친타월로 기름을 뺍니다.
- 아보카도 1개를 반으로 갈라 씨를 제거하고 얇게 썹니다. 산화 방지를 위해 레몬즙을 조금 뿌려도 좋습니다.
- 냄비에 물을 끓이고 식초 1큰술을 넣은 뒤 약불로 줄이고 숟가락으로 소용돌이를 만든 다음 달걀 2개를 넣어 약 3분 수란합니다(흰자가 굳고 노른자가 흐르게). 물기를 뺍니다.
- 구운 歐包에 아보카도와 培根을 순서대로 올리고 수란 2개를 얹습니다.
- 올리브 오일 1큰술을 뿌리고 바다소금 1/3작은술, 후추 1/4작은술을 뿌린 뒤 발사믹을 적당히 더해 따뜻할 때 낸다.
tips:
...
- 발사믹 별도 제공
faqs:
- question: 酪梨慢煎培根／歐包 Open 를 매장 스타일에 가깝게 만드는 핵심은 무엇인가요?
