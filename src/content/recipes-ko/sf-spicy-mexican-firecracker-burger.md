---
title: 老墨辣鞭炮漢堡 스타일 레시피
recipeId: sf-spicy-mexican-firecracker-burger
description: Second Floor Cafe 스타일로 牛肉排、起司、炸墨西哥辣椒、BBQ 醬、薯塊 구성을 살린, 매장 분량 기준의 재현 레시피입니다.
...
steps:
- 번이나 데니시 안쪽에 버터를 바르고 그릴에 노릇하게 굽는다. 牛肉排 180公克、起司 40公克、炸墨西哥辣椒 適量、薯塊 250公克를 준비한다.
- 중불에 패티나 가츠를 굽고 뒤집은 뒤 치즈를 올려 뚜껑을 덮고 30초간 뜸을 들여 녹인다.
- 아래 빵에 소스(橄欖油 1大匙、海鹽 1/3小匙、黑胡椒碎 1/4小匙、BBQ 醬 2大匙、辣椒碎 1/2小匙)를 바르고 양상추, 토마토, 피클, 패티, 달걀후라이를 올린다.
...
- 수제 칠리소스
faqs:
- question: 老墨辣鞭炮漢堡 를 매장 스타일에 가깝게 만드는 핵심은 무엇인가요?
