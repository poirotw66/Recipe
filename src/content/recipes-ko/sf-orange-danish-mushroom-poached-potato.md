...
- 팬에 기름을 두르고 메인 재료(橙香丹麥 2份、水波蛋 2顆、炒菇 120公克、炒薯 250公克의 치킨, 스테이크, 해산물 등)를 구워 소금·후추로 간한다.
- 달걀후라이나 수란을 만들고, 감자는 노릇해질 때까지 팬에 볶는다.
- 큰 접시에 데니시, 메인, 감자, 샐러드를 나누어 담고 소스(橄欖油 1大匙、海鹽 1/3小匙、黑胡椒碎 1/4小匙、起司醬 2大匙)를 뿌려 완성한다.
tips:
