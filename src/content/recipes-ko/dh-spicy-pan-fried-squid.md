...
description: 涓豆腐 辣炒中卷 를 집에서 재현하는 한국식 메인 레시피입니다.
...
steps:
- 오징어을 씻어 링 모양으로 썰고 양파는 채 썰고 대파는 큼직하게 썹니다.
- 팬에 식용유를 두르고 다진 마늘과 양파를 볶습니다.
- 오징어을 넣어 센 불에서 빠르게 볶아준 후 고추장, 고춧가루, 설탕을 가합니다.
...
- 참깨
faqs:
- question: 辣炒中卷 를 매장 스타일에 가깝게 만드는 방법은?
