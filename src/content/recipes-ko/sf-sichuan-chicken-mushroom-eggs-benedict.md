...
steps:
- 잉글리시 머핀을 반으로 잘라 버터를 바르고 180℃에서 노릇하게 굽는다. 歐包 2份、口水雞 180公克、奶油炒菇 120公克、水波蛋 2顆를 준비하고 버섯을 버터에 볶아둔다.
- 팬에 주재료(햄, 치킨, 소고기, 연어 등)를 구워 따뜻하게 보관한다. 소스(橄欖油 1大匙、海鹽 1/3小匙、黑胡椒碎 1/4小匙、辣椒碎 1/2小匙)를 준비한다.
- 냄비에 물을 끓여 식초를 넣고 회오리를 만든 뒤 달걀을 넣어 3분간 익혀 반숙 수란을 만든다.
- 머핀 위에 버섯볶음, 주재료, 수란을 순서대로 올리고 따뜻한 홀란다이즈 소스(橄欖油 1大匙、海鹽 1/3小匙、黑胡椒碎 1/4小匙、辣椒碎 1/2小匙)를 끼얹어 완성한다.
tips:
...
- 수제 칠리소스
faqs:
- question: 台胃口水雞奶油炒菇班尼蛋 를 매장 스타일에 가깝게 만드는 핵심은 무엇인가요?
